...
├── BLOG_TUTORIAL.md   # Full write-up / tutorial
├── data/
...
Sign up at [Nebius AI Studio](https://studio.nebius.com/) and create an API key.
...
Uses **Qwen3-235B-A22B-Thinking** via [Nebius Token Factory API](https://docs.nebius.com/studio/inference/token-factory) — a reasoning model that thinks through performance bottlenecks before proposing fixes. OpenAI-compatible API, no new SDK required.
